...
tf.app.flags.DEFINE_string('img_dir', './data/tmp','The directory store images.')
tf.app.flags.DEFINE_string('train_datas', 'train_data.txt','The images and their labels')
